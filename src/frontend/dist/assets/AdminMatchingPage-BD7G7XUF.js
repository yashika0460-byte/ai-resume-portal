import { c as createLucideIcon, q as useQueryClient, r as reactExports, j as jsxRuntimeExports, b as Button, Z as Zap, d as useActor, u as useAuth, X, e as createActor } from "./index-C0uoDo9R.js";
...
import { a as useMatchHistory, u as useResumes } from "./use-resumes-U5T9p0Y7.js";
...
import { a as CircleCheck, L as LoaderCircle, C as CircleX } from "./loader-circle-CHyPsDOr.js";
/**
...
function ScoreBar({ score }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-[120px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-1.5 rounded-full bg-muted/50 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function BulkMatchModal({ resumes, onClose, onDone }) {
  ...
  const runBulk = async () => {
    if (!actor || !(user == null ? void 0 : user.token) || selected.size === 0 || !jd.trim()) return;
    setIsRunning(true);
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "bulk-match.progress_list", children: progress.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    p.status === "done" && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-4 text-emerald-600 shrink-0" }),
                  ...
                  children: [
                    ...
                    histLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 rounded-2xl" }, i)) }) : jdList.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      ...
                      motion.div,
                      {
                        ...
                        className: `glass rounded-2xl border p-4 cursor-pointer transition-smooth group relative ${selectedJD === entry.jd ? "border-accent/40 bg-accent/5 accent-glow" : "border-border/20 hover:border-accent/20"}`,
                  ...
                  children: !selectedJD ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs", children: jdList.length > 0 ? "Choose a job description from the left panel to see match results." : "Run your first match to see how candidates compare against a job description." })
                      ]
                    }
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-3 border-b border-border/15 grid grid-cols-[2fr_1.5fr_1.5fr_1.5fr_1fr] gap-4 text-xs font-semibold text-muted-foreground", children: [
                          ...
                          histLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ...
                            motion.div,
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreBar, { score: record.matchScore }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  SkillList,
                                  {
