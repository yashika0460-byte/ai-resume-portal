import { c as createLucideIcon, f as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, h as clsx, R as React, i as invariant, u as useAuth, j as jsxRuntimeExports, k as LayoutDashboard, b as Button, l as Link, L as LoadingSpinner, S as Skeleton, d as useActor, U as User, e as createActor } from "./index-C0uoDo9R.js";
import { G as GlassCard, S as StatCard, a as SkillBadge, b as ScoreBadge } from "./SkillBadge-DWEbqy2E.js";
import { u as useResumes, a as useMatchHistory, b as useDeleteResume } from "./use-resumes-U5T9p0Y7.js";
...
function truncateFilename(name, max2 = 22) {
  if (name.length <= max2) return name;
  const ext = name.lastIndexOf(".");
  if (ext > 0) return `${name.slice(0, max2 - 4)}…${name.slice(ext)}`;
  return `${name.slice(0, max2 - 1)}…`;
}
function exportToCSV(resumes) {
  const sorted = [...resumes].sort((a22, b2) => b2.score - a22.score);
  ...
  a2.href = url;
  a2.download = `resumes-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`;
  a2.click();
        ...
        GlassCard,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground leading-relaxed", children: [
              ...
              " ",
              "will be permanently removed along with its match history. This cannot be undone."
            ] }),
...
function ChartTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-lg px-3 py-2 text-sm", children: [
...
function StatsBar({ resumes }) {
  ...
  const avg = total ? Math.round(resumes.reduce((s2, r) => s2 + r.score, 0) / total) : 0;
...
function ScoreChart({ resumes }) {
  const data = [...resumes].sort((a2, b2) => b2.score - a2.score).slice(0, 12).map((r) => ({ filename: r.filename, score: r.score }));
      ...
      BarChart,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              dataKey: "filename",
              tickFormatter: (v2) => truncateFilename(v2, 10),
              tick: {
    ...
    GlassCard,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2 leading-relaxed", children: "Upload your first candidate resume and the AI will extract skills, compute a match score, and populate this dashboard automatically." })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex flex-col sm:flex-row items-center gap-6 text-xs text-muted-foreground/60", children: [
...
function ResumeTable({ resumes, onDelete }) {
  const [search, setSearch] = reactExports.useState("");
  const [tier, setTier] = reactExports.useState("all");
  const sorted = [...resumes].sort((a2, b2) => b2.score - a2.score);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "overflow-hidden p-0", "data-ocid": "resume-table", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 flex flex-col sm:flex-row gap-3 border-b border-border/20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "tr",
        {
          ...
          children: ["#", "Filename", "Score", "Skills", "Actions"].map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "th",
            {
        ...
        "tr",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 min-w-[160px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1.5 rounded-lg bg-primary/10 border border-primary/20 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "size-3.5 text-primary" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 w-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "score-bar w-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
function MatchHistorySection({ matches }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { className: "overflow-hidden p-0", "data-ocid": "match-history-table", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        style: { borderBottom: "1px solid oklch(0.22 0.012 240 / 0.4)" },
        children: ["Resume", "Match Score", "Matched Skills", "Date"].map(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: sorted.map((match, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "tr",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 max-w-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1", children: [
            match.matchedSkills.slice(0, 4).map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkillBadge, { label: s2, status: "matched" }, s2)),
...
function TabButton({ active, onClick, icon, label, ocid }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      onClick,
      "data-ocid": ocid,
      className: `flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-colors duration-200 border ${active ? "bg-accent/15 border-accent/30 text-accent" : "border-border/30 text-muted-foreground hover:bg-muted/40 hover:text-foreground"}`,
      children: [
        icon,
        label
      ]
...
function UsersTab({ token, currentUserEmail }) {
  ...
  const handleDeleteConfirm = async () => {
    ...
    if (result.success) {
      setUsers((prev) => prev.filter((u2) => u2.email !== pendingDelete));
    } else {
  ...
  const filtered = users.filter(
    (u2) => u2.email.toLowerCase().includes(search.toLowerCase())
  );
  if (isLoading) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", "data-ocid": "users-tab", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "overflow-hidden p-0", "data-ocid": "users-table", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-b border-border/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 size-3.5 text-muted-foreground pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "tr",
          {
            ...
            children: ["Email", "Role", "Date Joined", "Actions"].map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "th",
              {
                className: "px-4 py-3.5 text-left text-xs font-semibold font-display uppercase tracking-wider text-muted-foreground",
                children: col
        ...
        ) }) }) : filtered.map((u2, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: "glass-hover",
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 min-w-[200px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1.5 rounded-lg bg-primary/10 border border-primary/20 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "size-3.5 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground truncate max-w-[240px]", children: u2.email })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 w-28", children: u2.role === "admin" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold bg-accent/15 border border-accent/30 text-accent", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "size-3" }),
                "Admin"
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold bg-muted/40 border border-border/30 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "size-3" }),
                "User"
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 w-36", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs", children: formatDate(u2.createdAt) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 w-20", children: u2.email.toLowerCase() !== currentUserEmail.toLowerCase() ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  variant: "ghost",
                  size: "icon",
                  className: "size-8 text-muted-foreground hover:bg-destructive/10 hover:text-destructive",
                  onClick: () => setPendingDelete(u2.email),
                  "data-ocid": `delete-user-btn-${idx}`,
                  "aria-label": `Delete user ${u2.email}`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "size-4" })
                }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4 fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-xl bg-accent/10 border border-accent/25", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutDashboard, { className: "size-5 text-accent" }) }),
          ...
          deleteMutation.isPending && !pendingDelete && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "fixed inset-0 z-40 flex items-center justify-center",
              style: { background: "oklch(0.60 0.014 240 / 0.20)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "lg", label: "Deleting resume…" })
            }
          )
        ] }),
        pendingDelete && /* @__PURE__ */ jsxRuntimeExports.jsx(
