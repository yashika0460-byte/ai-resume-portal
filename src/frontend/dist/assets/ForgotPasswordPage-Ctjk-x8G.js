import { c as createLucideIcon, a as useNavigate, d as useActor, r as reactExports, j as jsxRuntimeExports, C as ChevronLeft, B as BrainCircuit, L as LoadingSpinner, b as Button, e as createActor } from "./index-BW0DBoAl.js";
...
const STEPS = [
  { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "size-3.5" }), label: "Email" },
  { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleHelp, { className: "size-3.5" }), label: "Verify" },
  { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(KeyRound, { className: "size-3.5" }), label: "Reset" }
];
function ForgotPasswordPage() {
  ...
  const [step3Error, setStep3Error] = reactExports.useState(null);
  const [done, setDone] = reactExports.useState(false);
  const emailRef = reactExports.useRef(null);
  const answerRef = reactExports.useRef(null);
  const newPasswordRef = reactExports.useRef(null);
  ...
  reactExports.useEffect(() => {
    if (step === 3) setTimeout(() => {
      var _a;
      return (_a = newPasswordRef.current) == null ? void 0 : _a.focus();
    }, 120);
  }, [step]);
  ...
  const handleStep3Submit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setStep3Error(
          result.error ?? "Incorrect security answer. Please go back and try again."
        );
      }
    } catch {
  ...
  const isStep3Valid = !newPasswordError && !confirmError && newPassword.length > 0 && confirmPassword.length > 0;
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base sm:text-lg leading-relaxed max-w-md mx-auto lg:mx-0", children: "Answer your security question to verify your identity and set a new password. No email required." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: [
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  className: `flex items-center gap-3 text-sm transition-smooth ${isActive ? "text-accent" : isDone ? "text-accent/60" : "text-muted-foreground/50"}`,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `p-1.5 rounded-lg border shrink-0 transition-smooth ${isActive ? "bg-accent/10 border-accent/20 text-accent" : isDone ? "bg-accent/5 border-accent/10 text-accent/60" : "bg-muted/20 border-border/20"}`,
                        children: s.icon
                      }
                    ),
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-8 flex flex-col gap-6 relative overflow-hidden", children: [
                  ...
                  STEPS.map((s, i) => {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: `flex items-center justify-center size-7 rounded-full border text-xs font-bold transition-smooth ${isActive ? "bg-accent/20 border-accent/50 text-accent" : isDone ? "bg-accent/10 border-accent/30 text-accent/70" : "bg-muted/20 border-border/30 text-muted-foreground/40"}`,
                      ...
                      i < STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: `flex-1 h-px w-8 transition-smooth ${step > stepNum ? "bg-accent/30" : "bg-border/30"}`
                        }
                      )
                    ] }, s.label);
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-xs text-muted-foreground/60 font-body", children: [
                    step,
                    " / 3"
                  ] })
                ]
              ...
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "size-5 text-accent", "aria-hidden": "true" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: done && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                "aria-live": "polite",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 rounded-full bg-accent/10 border border-accent/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    CircleCheck,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground", children: "Password reset!" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Redirecting to sign in…" })
                  ] })
                ]
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { mode: "wait", children: [
              !done && step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.form,
                {
              ...
              !done && step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.form,
                {
                  ...
                  transition: { duration: 0.22 },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl p-3.5 flex items-start gap-2.5 text-xs bg-muted/40 border border-border/30", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        CircleHelp,
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-relaxed space-y-0.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-medium uppercase tracking-wide text-[10px]", children: "Your security question" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground text-sm font-medium", children: securityQuestion })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    verifying ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "lg" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-display font-medium text-foreground", children: "Verifying…" })
                        ]
                      }
                    ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
              ...
              !done && step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.form,
                {
                  ...
                  children: [
                    ...
                    step3Error && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.p,
                      {
                        className: "text-xs text-destructive bg-destructive/10 border border-destructive/20 rounded-lg px-3 py-2",
                        initial: { opacity: 0, y: -6 },
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        children: "← Back to security question"
                      }
                    )
                  ]
                },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-sm text-muted-foreground border-t border-border/20 pt-2", children: [
