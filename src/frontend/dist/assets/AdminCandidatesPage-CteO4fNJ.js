import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, s as React, t as composeRefs, v as reactDomExports, w as useComposedRefs, x as ReactDOM, g as cn, y as buttonVariants, p as useQueryClient, b as Button, X } from "./index-BW0DBoAl.js";
import { B as Badge } from "./badge-D8TMHCDX.js";
import { C as Check } from "./check-9sDBKiUa.js";
import { I as Input, S as Skeleton } from "./skeleton-DPufJtYQ.js";
import { u as useResumes, b as useDeleteResume } from "./use-resumes-BkByy20o.js";
...
function exportCSV(rows, filename = "candidates.csv") {
...
function ScoreCell({ score }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-[110px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-sm font-mono font-bold w-7 shrink-0 ${color}`, children: score }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-1.5 rounded-full bg-muted/30 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function SkillChips({ skills }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 max-w-[240px]", children: [
    visible.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Badge,
      {
        variant: "secondary",
    ...
    overflow > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TooltipContent,
        {
          ...
          children: skills.slice(MAX_VISIBLE).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function SkeletonRow() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-4 h-4 rounded" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-6 h-4 rounded" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-40 h-4 rounded" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-28 h-4 rounded" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-48 h-4 rounded" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-20 h-4 rounded" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-20 h-4 rounded" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-16 h-4 rounded" }) })
  ] });
}
function SortIcon({ active, dir }) {
  if (!active) return /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpDown, { className: "size-3 opacity-30" });
  return dir === "asc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUp, { className: "size-3 text-accent" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "size-3 text-accent" });
}
function AdminCandidatesPage() {
  ...
  const [search, setSearch] = reactExports.useState(() => getParams().get("q") ?? "");
  const [minScore, setMinScore] = reactExports.useState(
    () => getParams().get("minScore") ?? ""
  );
  const [maxScore, setMaxScore] = reactExports.useState(
  ...
  const [dateTo, setDateTo] = reactExports.useState(() => getParams().get("dateTo") ?? "");
  const [sortField, setSortField] = reactExports.useState(
    () => getParams().get("sort") ?? "score"
  );
  const [sortDir, setSortDir] = reactExports.useState(
    () => getParams().get("dir") ?? "desc"
  );
  ...
  const syncTimeout = reactExports.useRef(null);
  reactExports.useEffect(() => {
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    const skillTerms = skillFilter.split(",").map((s) => s.trim().toLowerCase()).filter(Boolean);
    const min2 = minScore !== "" ? Number(minScore) : null;
    const max2 = maxScore !== "" ? Number(maxScore) : null;
    const from = dateFrom ? new Date(dateFrom).getTime() : null;
    const to = dateTo ? (/* @__PURE__ */ new Date(`${dateTo}T23:59:59`)).getTime() : null;
    return resumes.filter((r) => {
      if (q && !r.filename.toLowerCase().includes(q)) return false;
      if (min2 !== null && r.score < min2) return false;
      if (max2 !== null && r.score > max2) return false;
  ...
  const prevFiltered = reactExports.useRef(filtered.length);
  reactExports.useEffect(() => {
  ...
  const hasFilters = search || minScore || maxScore || skillFilter || dateFrom || dateTo;
  const clearFilters = () => {
    setSearch("");
    setMinScore("");
    setMaxScore("");
  ...
  const Th = ({
    ...
    "th",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
        label,
        /* @__PURE__ */ jsxRuntimeExports.jsx(SortIcon, { active: sortField === field, dir: sortDir })
      ] })
    }
  );
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-xl bg-accent/15 border border-accent/30 shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "size-5 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl text-foreground", children: "Candidates" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: isLoading ? "Loading resumes…" : `${resumes.length} resume${resumes.length !== 1 ? "s" : ""} · ${filtered.length} matching` })
            ] })
          ] }),
        ...
        someSelected && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/20 bg-muted/40", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3.5 w-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Checkbox,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Th, { field: "rank", label: "#", className: "w-12" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Th, { field: "filename", label: "Filename" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Th, { field: "score", label: "Score", className: "w-44" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3.5 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Skills" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3.5 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider w-28", children: "Status" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Th, { field: "uploadDate", label: "Uploaded", className: "w-36" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3.5 text-right text-xs font-semibold text-muted-foreground uppercase tracking-wider w-24", children: "Actions" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
                  isLoading && SKELETON_KEYS.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonRow, {}, k)),
                  !isLoading && resumes.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 8, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "flex flex-col items-center justify-center py-16 gap-3",
                      "data-ocid": "admin-candidates.empty_state",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 rounded-2xl bg-accent/10 border border-accent/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "size-8 text-accent" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-base", children: "No candidates yet" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center max-w-xs", children: "Candidates will appear here once resumes are uploaded." })
                      ]
                    }
                  ) }) }),
                  !isLoading && resumes.length > 0 && filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 8, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "flex flex-col items-center justify-center py-12 gap-3",
                      "data-ocid": "admin-candidates.filter_empty_state",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "size-8 text-muted-foreground" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: "No results match your filters" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Button,
                          {
                            variant: "outline",
                  ...
                  !isLoading && pageItems.map((resume, idx) => {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "tr",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-muted-foreground", children: rank }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 max-w-[180px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreCell, { score: resume.score }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkillChips, { skills: resume.skills }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            StatusBadge,
                            {
                              status,
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-xs text-muted-foreground whitespace-nowrap", children: formatDate(resume.uploadDate) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1", children: [
                            resume.fileUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "top", children: "Download PDF" })
                            ] }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "top", children: "Delete resume" })
                            ] }) })
                          ] }) })
                        ]
                      },
              ...
              !isLoading && totalPages > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-3 border-t border-border/15 bg-muted/10 flex items-center justify-between gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AlertDialog,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "admin-candidates.delete_dialog", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete this resume?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: "This action cannot be undone. The resume and all its match history will be permanently removed." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "admin-candidates.delete_cancel_button", children: "Cancel" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  AlertDialogAction,
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: bulkDeleteOpen, onOpenChange: setBulkDeleteOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "admin-candidates.bulk_delete_dialog", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
