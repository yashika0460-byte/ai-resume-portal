/**
 * AdminUsersPage — Full user management dashboard for admin portal.
...
function RoleBadge({ role }: { role: string }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold bg-muted text-muted-foreground border border-border/40">
...
function StatCard({
  ...
  return (
    <div className="glass rounded-2xl p-5 border border-border/20 flex items-start gap-4">
...
export default function AdminUsersPage() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Table toolbar */}
        <div className="px-6 py-4 border-b border-border/15 flex items-center justify-between gap-4">
        ...
        {/* Column headers */}
        <div className="hidden sm:grid grid-cols-[auto_1fr_130px_160px_110px] gap-4 px-6 py-3 border-b border-border/10 bg-muted/10">
          {/* Select all */}
          <button
            type="button"
              ...
              >
                ...
                <button
                  ...
                  className={`w-4 h-4 rounded border-2 flex items-center justify-center transition-colors shrink-0 ${
                    isSelf
                      ? "border-muted-foreground/20 cursor-not-allowed opacity-30"
                      : isSelected
